...
<tr><th>Hotel Name,Location</th><th>No. Of Bookings</th></tr>
<%
	for(Mdeals m: alist)
	{
%>
<tr><td><%= m.getLocation() %></td><td><%= m.getNumbooks() %></td>
<td><a href="FetchBookingDetails?hotelname=<%= m.getLocation()%>">Customers List</a></td></tr>
<% } %>
</table>
<div id="footer">
